...
def abrir_menu_pedidos(janela_pai: tk.Tk):
    ...
    ui.configurar_janela(win, "PEDIDOS", 500, 300)
...
def iniciar_sistema():
    ...
    janela = tk.Tk()
    ui.configurar_janela(janela, "Sistema de Pedidos - Bodega", 720, 550)

    # ── Cabeçalho principal ──
    ui.frame_cabecalho(janela, "⬛  SISTEMA DE PEDIDOS  —  BODEGA")

    tk.Label(janela, text="Estrutura de Dados  |  3ª Fase / 2026  |  Prof. Emanuel Tonis Florz", font=ui.FONTE_PEQUENA, bg=ui.COR_FUNDO, fg=ui.COR_BORDA,).pack(pady=(4, 0))
    ...
    tk.Label(frame, text="MENU PRINCIPAL", font=ui.FONTE_TITULO, bg=ui.COR_FUNDO, fg=ui.COR_DESTAQUE,).pack(pady=(0, 14))
