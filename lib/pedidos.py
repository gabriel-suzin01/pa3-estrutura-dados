...
def abrir_lancamento_pedido(container: tk.Frame):
    ...
    lbl_total = tk.Label(
        frame, text="", font=ui.FONTE_NORMAL, bg=ui.COR_FUNDO, fg=ui.COR_SUCESSO
    )
    ...
    fr_btn.pack(pady=6)
    ui.botao_acao(fr_btn, "✔  Lançar Pedido", confirmar_pedido, cor="#313244").pack(
        side="left", padx=6
    )
    from sistema import renderizar_menu_principal
