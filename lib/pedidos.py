# ============================================================
# pedidos.py - Módulo de Pedidos (Lançamento)
# ============================================================
...
def abrir_lancamento_pedido(janela_pai: tk.Widget):
    """Abre a tela de lançamento de pedido."""
    win = tk.Toplevel(janela_pai)
    ui.configurar_janela(win, "Lançar Pedido", 580, 540)
    ui.frame_cabecalho(win, "⬛  LANÇAR PEDIDO")
    ...
    tk.Label(fr_sel, text="ID do Produto:", font=ui.FONTE_NORMAL,
    ...
    tk.Label(fr_sel, text="Quantidade:", font=ui.FONTE_NORMAL,
    ...
    lbl_total = tk.Label(frame, text="", font=ui.FONTE_NORMAL,
    ...
    def confirmar_pedido():
        ...
        if produto is None:
            ui.mensagem_erro(f"Produto ID {id_p} não encontrado."); return
        ...
        pedido = {
            ...
            "qtd":            qtd,
            "valor_unitario": f"{val_unit:.2f}",
            "valor_total":    f"{val_total:.2f}",
            "status_pedido":  "A",
        }
