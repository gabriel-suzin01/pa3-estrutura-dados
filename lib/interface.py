...
def configurar_janela(titulo: str, fullscreen: bool = True, largura: int = 700, altura: int = 520,) -> tk.Tk:
...
def label_campo(container: tk.Widget, texto: str) -> tk.Label:
    ...
    return tk.Label(container, text=texto, font=FONTE_NORMAL, bg=COR_FUNDO, fg=COR_TEXTO, anchor="w")
...
def criar_treeview(container: tk.Widget, colunas, altura: int = 12) -> ttk.Treeview:
    ...
    tree = ttk.Treeview(container, columns=ids, show="headings", height=altura, style="Custom.Treeview")
